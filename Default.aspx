        ...
        <div id="b2b-content-default">
            <div id="b2b-login">
                <div class="login-box">
                    <table>
                        <tr>
                            <td colspan="2" valign="top"><asp:Image runat="server" src="images/b2b_login_title.png" alt="" class="login-title" /></td>
                        </tr>
                        <tr>
                            <td align="right" class="login-title">帳號：</td>
                            <td><asp:TextBox ID="TextBox1" runat="server" class="login-textBox" /></td>
                        </tr>
                        <tr>
                            <td align="right" class="login-title">密碼：</td>
                            <td><asp:TextBox ID="TextBox2" runat="server" class="login-textBox" TextMode="Password" /></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="bottom">
                                ...
                                <img id="MzImgExpPwd"  class="login-box-code" align="absmiddle" name="MzImgExpPwd" 
                                    onclick="javascript:document.getElementById('MzImgExpPwd').src='gif.aspx?temp='+ (new Date().getTime().toString(36));  return false"
                                    src="gif.aspx" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <span class="login_box_red"><a href="A_Join.aspx">申請帳號</a> | <a href="forgetPW.aspx">忘記密碼</a></span>　
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                ...
                <div class="login-info">
                    ...
                    <span class="info-link"><a href="http://sample_rwd_a.grp.com.tw/" target="_blank">RWDA</a></span>、
                    <span class="info-link"><a href="http://sample_rwd_b.grp.com.tw/" target="_blank">RWDB</a></span>、
                    <span class="info-link"><a href="http://sample_rwd_c.grp.com.tw/" target="_blank">RWDC</a></span>
                    <br> 單頁版型: <!-- <span class="info-link"><a href="http://sample.grp.com.tw/single_0/" target="_blank">範例</a></span>、 -->
                    <span class="info-link"><a href="http://sample_rwd_0.grp.com.tw/" target="_blank">RWD單頁</a></span>
                    <br> 申請方式: <span class="info-link"><a href="http://b2b.artisan.com.tw/B2B2C/001.html" target="_blank">詳情簡介</a></span><br> 電話:02-2506-3038 或將貴公司的聯絡資料E-MAIL至麥斯科技
                </div>
            </div>

            <div id="b2b-bannerBar">
