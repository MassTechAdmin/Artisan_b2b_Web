						...
						<table cellSpacing="0" cellPadding="0" border="0">
							<TR>
								<TD nowrap>
									...
									<input id="txtWidth" onkeypress="return IsDigit(event);" type="text" value="390" size="3">
								</TD>
								<TD>&nbsp;</TD>
								<TD>
									<span fckLang="DlgImgHeight">Height</span><br>
									<input id="txtHeight" onkeypress="return IsDigit(event);" type="text" value="300" size="3">
								</TD>
							</TR>
						</table>
					</TD>
							...
							<tr>
								<td valign="top" width="100%">
									<table cellSpacing="0" cellPadding="0" width="100%">
										...
										<tr>
											<td id="ePreviewCell" valign="top" class="FlashPreviewArea"><iframe src="fck_flash/fck_flash_preview.aspx" frameborder="0" marginheight="0" marginwidth="0"></iframe></td>
										</tr>
									</table>
								</td>
							</tr>
			...
			<TABLE cellSpacing="0" cellPadding="0" border="0">
				<TR>
					...
					<td valign="bottom">
						<table>
							<tr>
								<td><input id="chkAutoPlay" type="checkbox"></td>
