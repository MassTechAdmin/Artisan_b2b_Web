<%@ Page Language="C#" MasterPageFile="~/Trip/MasterPage.master" AutoEventWireup="true" CodeFile="Home_Banner.aspx.cs" Inherits="Trip_Home_Banner" Title="Untitled Page" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="號碼">
                                <ItemTemplate>
                                <asp:HiddenField ID="hidChose_No" runat="server" Value='<%# Eval("HB_No") %>' />
                            ...
                            <asp:TemplateField HeaderText="圖片">
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# "../" + Eval("HB_Pic") %>' Width="100px" />
                                </ItemTemplate>
                                <ItemStyle Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="超連結">
                                <ItemTemplate>
                                    <asp:Label ID="lblChose_Link" runat="server" Text='<%# Eval("HB_Link") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="200px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="排序">
                                <ItemTemplate>
                                    <asp:TextBox ID="txbchose_order" runat="server" Text='<%# Eval("HB_Order") %>' Width="20px"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="60px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "Home_Banner_Region.aspx?no=" + Eval("HB_No") %>' >Edit</asp:HyperLink>
                                </ItemTemplate>
