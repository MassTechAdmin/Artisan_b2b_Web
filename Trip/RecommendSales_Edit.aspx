<%@ Page Language="C#" MasterPageFile="~/Trip/MasterPage.master" AutoEventWireup="true" CodeFile="RecommendSales_Edit.aspx.cs" Inherits="RecommendSales_Edit" Title="Untitled Page" validateRequest="false" %>
...
<table style="width: 700px">
        ...
        <tr>
            ...
            <td style="width: 400px">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button
               ID="Button2" runat="server" Text="取消" PostBackUrl="~/Trip/RecommendSales.aspx" /></td>
        </tr>
    </table>
