<%@ Page Language="C#" MasterPageFile="~/Trip/MasterPage.master" AutoEventWireup="true" CodeFile="GoldSales.aspx.cs" Inherits="Trip_GoldSales" Title="Untitled Page" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="自動編號" SortExpression="自動編號">
                <ItemTemplate>
                    ...
                    <asp:HiddenField ID="HidKeyWord_No" Value='<%# Eval("Gold_No") %>' runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="排序">
                 <ItemTemplate>
                     <asp:TextBox ID="TxbOrder" runat="server" Text='<%# Eval("Gold_Order") %>' Width="20px"></asp:TextBox>
                  </ItemTemplate>
                 <ItemStyle Width="20px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="標題">
                 <ItemTemplate>
                     <asp:Label ID="lblArea" runat="server" Text='<%# Eval("Gold_Title") %>'></asp:Label>
                  </ItemTemplate>
                 <ItemStyle Width="200px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="價格">
                 <ItemTemplate>
                     <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Gold_Pirce") %>'></asp:Label>
                  </ItemTemplate>
           ...
           <ItemTemplate>
                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "GoldSales_Edit.aspx?no=" + Eval("Gold_No") %>'>Edit</asp:HyperLink>
            </ItemTemplate>
