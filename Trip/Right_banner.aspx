<%@ Page Language="C#" MasterPageFile="~/Trip/MasterPage.master" AutoEventWireup="true" CodeFile="Right_banner.aspx.cs" Inherits="Trip_Right_banner" Title="Untitled Page" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "Right_banner_Region.aspx?no=" + Eval("banner_No") %>' >Edit</asp:HyperLink>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="圖片">
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# "../ad3/img/" + Eval("banner_Pic") %>' Width="200px" />
                                </ItemTemplate>
