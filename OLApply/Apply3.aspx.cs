...
public partial class OLApply_Apply3 : System.Web.UI.Page
{
    ...
    protected void Load_Data()
    {
        ...
        value1 += int.Parse(Price_Total_1.Text, NumberStyles.AllowThousands);
        value1 += int.Parse(Price_Total_2.Text, NumberStyles.AllowThousands);
        value1 += int.Parse(Price_Total_3.Text, NumberStyles.AllowThousands);
    ...
    protected void fn_Save_TR20(string strTr10Number)
    {
        ...
        for (int i = 0; i <= 3; i++)
        {
            ...
            strSql += " Tr10Number ,Enli_Date ,GROP_NUMB ,BookPax ,Tour_Mony ,Tick_Type ,Bed_Type ";
            strSql += " ) VALUES ( ";
            strSql += " @Tr10Number ,@Enli_Date ,@GROP_NUMB ,@BookPax ,@Tour_Mony ,@Tick_Type ,@Bed_Type ";
            strSql += " ) ";
