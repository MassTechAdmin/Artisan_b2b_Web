                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td colspan="5" align="left" valign="middle">
                                <asp:Label ID="Lbl_Grop_Numb" runat="server" />　<asp:Label ID="Lbl_Grop_Name" runat="server" /></td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle" bgcolor="#EEEEEE">旅客型別</td>
                            <td width="200" align="center" valign="middle" bgcolor="#EEEEEE">團體售價</td>
                            <td width="119" align="center" valign="middle" bgcolor="#EEEEEE">單價</td>
                            <td width="178" align="center" valign="middle" bgcolor="#EEEEEE">折扣</td>
                            <td width="178" align="center" valign="middle" bgcolor="#EEEEEE">人數</td>
                            <td width="183" align="center" valign="middle" bgcolor="#EEEEEE">銷售金額</td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle">大　　人</td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Show_0" runat="server" /></td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Single_0" runat="server" /></td>
                            ...
                            <td align="center" valign="middle"><asp:Label ID="Price_Total_0" runat="server" /></td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle">小孩佔床</td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Show_1" runat="server" /></td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Single_1" runat="server" /></td>
                            ...
                            <td align="center" valign="middle"><asp:Label ID="Price_Total_1" runat="server" /></td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle">小孩加床</td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Show_2" runat="server" /></td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Single_2" runat="server" /></td>
                            ...
                            <td align="center" valign="middle"><asp:Label ID="Price_Total_2" runat="server" /></td>
                        </tr>
                        <tr>
                            <td align="center" valign="middle">小孩不佔床</td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Show_3" runat="server" /></td>
                            <td align="center" valign="middle"><asp:Label ID="Price_Single_3" runat="server" /></td>
                            ...
                            <td align="center" valign="middle"><asp:Label ID="Price_Total_3" runat="server" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center" valign="middle" style="color: #FF0000;line-height:20px;">
                                團體售價　　<asp:Label ID="PT1" runat="server" /><br />
