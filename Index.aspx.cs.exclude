...
public partial class index : System.Web.UI.Page
{
    ...
    protected void fn_Show_Gold_Sales()
    {
        ...
        //20200327
        strSql += "        when Gold_Sales.Gold_Area = '90003' then '日本'";
        ...
        strSql += " and Area.Area_ID in ('Area1','Area2','Area3','Area4','Area6','Area7','Area11','Area10','Area21','Area18')";
        strSql += " order by  Area_B2B_OrderBy,Gold_Area,Gold_Order ";
        string constring = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["B2BConnectionString"].ToString();
        SqlConnection connect = new SqlConnection(constring);
        try
        {
