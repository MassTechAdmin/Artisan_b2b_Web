...
public partial class OLApply_Check : System.Web.UI.Page
{
    ...
    {
        string strSql = "";
        strSql += " select AGT_NAME2 ,IND_FG_CompNO ,IND_FG_ID ,IND_FG_PW ,IND_FG_Name ,IND_FG_EMail ,IND_FG_TEL ,IND_FG_TEL2 ,IND_FG_TEL3 ,IND_FG_Phone ";
        strSql += " FROM IND_FG";
        ...
        try
        {
            ...
            if (reader.Read())
            {
                ...
                //統一編號
                Lbl_Comp_No.Text = reader["IND_FG_CompNO"].ToString();
                //會員帳號
                Lbl_Account.Text = reader["IND_FG_ID"].ToString();
                //密碼
                Lbl_PassWord.Text = reader["IND_FG_PW"].ToString();
                //中文姓名
                Lbl_Name.Text = reader["IND_FG_Name"].ToString();
                //電子郵件
                Lbl_EMail.Text = reader["IND_FG_EMail"].ToString();
                //公司電話
                Lbl_Tel1.Text = reader["IND_FG_TEL"].ToString();
                Lbl_Tel2.Text = reader["IND_FG_TEL2"].ToString();
                Lbl_Tel3.Text = reader["IND_FG_TEL3"].ToString();
                //行動電話
