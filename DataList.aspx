...
<body>
    ...
    <uc1:Header ID="Header1" runat="server" />
       <table border="0" style="margin-top: 20px; padding-left: 20px; width:700px;">
  <tr>
    <td>電腦編號：<asp:Label ID="Label1" runat="server" BackColor="WhiteSmoke" Width="60px"></asp:Label></td>
    <td>現在使用者：<asp:Label ID="Label2" runat="server" BackColor="WhiteSmoke" Width="60px"></asp:Label></td>
    <td>建檔日期：<asp:Label ID="Label3" runat="server" BackColor="WhiteSmoke" Width="80px"></asp:Label></td>
    <td>建檔人員：<asp:Label ID="Label4" runat="server" BackColor="WhiteSmoke" Width="60px"></asp:Label></td>
  </tr>
</table>
    
<table width="750px" border="0"  style="padding-left:15px;height:38px;">
  <tr>
    <td><div style="border-bottom: dashed 1px #CCCCCC;"></div></td>
  </tr>
</table>

    <table border="0" style="width: 750px; padding-left:20px;">
        <tr>
            <td colspan="3">
                <h2 style="font-size:20px; font-weight:bold; padding-bottom:10px;">線上報名單</h2></td>
        </tr>
        <tr>
    ...
    <br /><br />
    <div style="margin-left: 200px; background-image: url(images/ps_bg.gif);background-repeat: x-repeat; padding:10px; letter-spacing:1px; border:solid #CCCCCC 1px;font-size:13px;width:730px;height:100px;">
        ...
        <span style="color:#555555; width: 500px; line-height:28px; ">
            ...
            　　<br />
            　　本報名單，將於十分鍾內正式成立，業務員將隨後與您確認本次報名資料。
        </span>
    </div>
    <br /><br />
    <h2>旅客明細</h2>
    <asp:GridView ID="GridView1" runat="server" EmptyDataText="<p>尚未建立資料或未找到您所搜尋的資料</p>" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="旅客姓名">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="出生日期">
                <ItemTemplate>
                    <asp:TextBox ID="lblBIRT_DATE" runat="server" Text='<%# fn_Rtn_DATE( Convert.ToDateTime(Eval("BIRT_DATE"))) %>' Width="62" MaxLength="10"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="護照發照日">
                <ItemTemplate>
                    <asp:TextBox ID="lblPASS_ISSU" runat="server" Text='<%# fn_Rtn_DATE(Convert.ToDateTime(Eval("PASS_ISSU"))) %>' Width="62" MaxLength="10"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="護照效期">
                <ItemTemplate>
                    <asp:TextBox ID="lblPASS_VALI" runat="server" Text='<%# fn_Rtn_DATE(Convert.ToDateTime(Eval("PASS_VALI"))) %>' Width="62" MaxLength="10"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
